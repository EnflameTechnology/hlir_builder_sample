...
std::shared_ptr<builder::Builder> build_sample() {
  ...
  auto res = builder::MaxPool2D(
      input, /*ksize=*/{2, 2}, /*ceil_mode=*/false,
      /*return_indices=*/false, /*auto_pad =*/"NOTSET",
      /*layout=*/"NCHW", /*stride=*/{2, 2}, /*padding=*/{0, 0, 0, 0});
  res.SetAttribute("op_name", builder::Attribute("MaxPool2D"));
