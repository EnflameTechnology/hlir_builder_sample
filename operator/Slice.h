...
std::shared_ptr<builder::Builder> build_sample(){
    ...
    builder::Op res = builder::Slice(/* builder::Op operand = */ operand, 
                                     /* std::vector<int64_t> start_indices = */{0, 1}, 
                                     /* std::vector<int64_t> limit_indices = */{7, 7}, 
                                     /* std::vector<int64_t> strides = */ {2, 2}, 
                                     /* builder::Type resultType = */ output_type);


    res.SetAttribute("op_name", builder::Attribute("Slice"));
