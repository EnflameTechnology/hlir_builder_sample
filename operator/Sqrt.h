...
float g_exps[] = {0, 2.23607, 1.73205, 2.44949, 
                  1.73205, 1.73205, 0, 2.44949, 
                  1.73205, 1.73205, 0, 2.44949, 
                  1.73205, 1.73205, 0, 2.44949, 
                  
                  2, 2.44949, 2.44949, 1.41421, 
                  3, 1.41421, 1, 1.73205, 
                  1.73205, 1, 2.23607, 2.23607, 
                  1.73205, 1, 2.23607, 2.23607, 

                  2.82843, 1.41421, 2.44949, 2.23607, 
                  2.23607, 0, 2.23607, 3, 
                  2.64575, 2.44949, 2.64575, 
                  2.44949, 2.23607, 1.41421, 3, 2};
...
std::shared_ptr<builder::Builder> build_sample(){
    ...
    builder::Op res = builder::Sqrt(/* builder::Op operand = */ data, 
                                     /*  builder::Type resultType = */ data_type);


    res.SetAttribute("op_name", builder::Attribute("Sqrt"));
