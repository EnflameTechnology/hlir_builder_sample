...
*/
// inputs and outputs
float g_lhs[] = {0.f, 1.f, 2.f, 3.f, 4.f, 5.f, 6.f, 7.f, 8.f, 
                9.f, 10.f, 11.f, 12.f, 13.f, 14.f, 15.f, 16.f, 17.f, 
                18.f, 19.f, 20.f, 21.f, 22.f, 23.f, 24.f, 25.f, 26.f};
float g_rhs[] = {27.f, 28.f, 29.f, 30.f, 31.f, 32.f, 33.f, 34.f, 35.f, 
                36.f, 37.f, 38.f, 39.f, 40.f, 41.f, 42.f, 43.f, 44.f, 
                45.f, 46.f, 47.f, 48.f, 49.f, 50.f, 51.f, 52.f, 53.f};
float g_exps[] = {27.f, 29.f, 31.f, 33.f, 35.f, 37.f, 39.f, 41.f, 43.f, 45.f, 47.f, 49.f, 51.f, 53.f, 55.f, 57.f, 59.f, 61.f, 63.f, 65.f, 67.f, 69.f, 71.f, 73.f, 75.f, 77.f, 79.f};
...
std::shared_ptr<builder::Builder> build_sample(){
    ...
    auto itype = builder::PrimitiveType::F32();
    std::vector<int64_t> in_shape{1, 3, 3, 3}; // NCHW
    builder::Type input_type(in_shape, itype);

    builder::Op arg0 = hlir_builder->CreateInput(input_type);
    builder::Op arg1 = hlir_builder->CreateInput(input_type);

    auto atype = builder::PrimitiveType::F16();
    builder::Type convert_type(in_shape, atype);
    builder::Op arg0_fp16 = builder::Convert(arg0, convert_type);
    builder::Op arg1_fp16 = builder::Convert(arg1, convert_type);

    builder::Op res = builder::Add(arg0_fp16, arg1_fp16);
    builder::Op res_fp32 = builder::Convert(res, input_type);

    res.SetAttribute("op_name", builder::Attribute("Add"));
    hlir_builder->SetOutput({res_fp32});
